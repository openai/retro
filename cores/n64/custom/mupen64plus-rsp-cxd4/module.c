...
#include "../../../mupen64plus-rsp-cxd4/module.h"
#include "../../../mupen64plus-rsp-cxd4/su.h"
...
NOINLINE void update_conf(const char* source)
{
    ...
    CFG_HLE_GFX = 0;
    CFG_HLE_AUD = 0;
    CFG_WAIT_FOR_CPU_HOST = 0;
    CFG_MEND_SEMAPHORE_LOCK = 0;
}
...
EXPORT u32 CALL lleDoRspCycles(u32 cycles)
{
...
EXPORT void CALL lleInitiateRSP(RSP_INFO Rsp_Info, pu32 CycleCount)
{
...
EXPORT void CALL lleRomClosed(void)
{
    FILE* stream;
